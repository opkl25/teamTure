	    ...
	    <div class="container d-flex flex-wrap justify-content-center">
	      ...
	      <form class="col-12 col-lg-auto mb-3 mb-lg-0">
	       ...
	       <c:if test="${member != null}">
			<div>
				<p id="login"><span class="mid">${member.mid}</span>&nbsp;<strong id="sir">님</strong></p>
				<input id="logout" type="button" class="btn btn-outline-info" value="로그아웃" onclick="location.href='/controller/logout.do'">
			</div>
			</c:if>
	    </div>
	    ...
	    <ul class="navbar-nav mb-2 mb-lg-0">
		 ...
		 <li class="nav-item dropdown">
	      ...
	      <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
		        ...
		        <c:if test="${member != null}">
		          <a class="nav-link" href="/controller/member/mypage.do">마이페이지</a>
		        </c:if>
		        </li>
